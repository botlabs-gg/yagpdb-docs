...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Outputs the &quot;string&quot; after cutting/slicing off integer (numeric)
        ...
        <a
        href="templates.md#how-to-get-ids">Snippets</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">Slices given <code>&quot;string&quot;</code> to sub-strings separated by <code>&quot;sepr&quot;</code>arg
        and returns new slice/array of the sub-strings. Example in <a href="templates.md#snippets">Snippets</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">Adds all regex matches from the string to a slice. Example in <a href="templates.md#snippets">Snippets</a>.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style="text-align:left">
        <p><b>Currently this function does not work properly!</b>
        </p>
        <p>Returns whole-pattern matches and also the sub-matches within those matches
          as slices inside a slice. <code>{{ reFindAllSubmatches &quot;(?i)y([a-z]+)g&quot; &quot;youngish YAGPDB&quot; }} </code>returns<code> [[young oun] [YAG A]] </code>(regex
          pattern here is case-insensitive).</p>
      </td>
    </tr>
  </tbody>
